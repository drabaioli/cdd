...
- [x] Docs capability (read-only verbs, JSON shapes, context-cost caps) + Confluence reference adapter, trigger-gated in five session commands, validated on a real page.
