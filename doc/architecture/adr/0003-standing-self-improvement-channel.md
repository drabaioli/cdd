...
- The three channels are complementary, not duplicative: the pre-PR check fires at **discovery**
  ...
  `/cdd-retrofit`'s upstream-candidates step at **upgrade** time on the accumulated diff. A general
  improvement now has three independent chances of reaching CDD.
