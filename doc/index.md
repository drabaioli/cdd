...
Documentation map for the CDD repository. Each directory keeps an `index.md` pointer list: read the index, then load only the documents you need.
...
- `knowledge_base/` — process doc, roadmap, engineering practices
  ...
  - [`founding-objectives-audit.md`](knowledge_base/founding-objectives-audit.md) — investigation note: audit of CDD's three founding objectives and the Phase 11 gap inventory
